...
TARS is a Python toolkit for two workflows:
...
- `examples/` — conversation and LaTeX samples.
...
- Some tests are dependency-guarded and skipped if optional runtime packages are missing.
